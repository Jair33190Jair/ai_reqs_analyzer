...
Use `ai_context.md` as the front door. Use these files when you
...
| --- | --- | --- |
| `/review diagram` | Review the architecture diagram on its own | `repo_reviews/reviews/{ddmmyy}_diagram.json` |
| `/review code` | Review Python code quality | `repo_reviews/reviews/{ddmmyy}_code.json` |
| `/review consistency` | Cross-check diagram vs code | `repo_reviews/reviews/{ddmmyy}_consistency.json` |
| `/review architecture` | Assess overall architecture | `repo_reviews/reviews/{ddmmyy}_architecture.json` |
| `/review project` | Review repo presentation and navigability | `repo_reviews/reviews/{ddmmyy}_project.json` |
...
- When unsure, use `type: "QUESTION"` instead of forcing a
  `FINDING`.
- Write review files to `repo_reviews/reviews/` using
  `{ddmmyy}_{type}.json`.
